CREATE DATABASE  IF NOT EXISTS `website_forum` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `website_forum`;
-- MySQL dump 10.13  Distrib 5.7.9, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: website_forum
-- ------------------------------------------------------
...
CREATE TABLE `temp_users` (
  `temp_user_id` int(8) NOT NULL AUTO_INCREMENT,
  `temp_user_name` varchar(30) NOT NULL,
  `temp_user_pass` varchar(255) NOT NULL,
  `temp_user_email` varchar(255) NOT NULL,
  `temp_user_date` datetime NOT NULL,
  `temp_user_level` int(8) NOT NULL DEFAULT '0',
  `temp_user_icon` varchar(255) NOT NULL,
